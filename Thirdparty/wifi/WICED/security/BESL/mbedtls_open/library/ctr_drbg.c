                     ...
                     const unsigned char *additional, size_t len )
{
    ...
    {
        /* WICED_MBEDTLS Start */
        /* coverity-76840 [Out-of-bounds read]
             FALSE-POSITIVE: When seedlen is 384, Coverity is not taking len into consideration. As an input seedlen can be 384, and if len is 0 it will not come inside if condition. so there are no chances
             of being out of bound read.  */
        /* WICED_MBEDTLS End */
