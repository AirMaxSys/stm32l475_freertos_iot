...
/* Avoid descriptive names to Cipher Suite definition */
    ...
    {
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_NULL_MD5)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_RC4_128_MD5)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_DES_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_DES_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_NULL_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_256_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_CAMELLIA_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_CAMELLIA_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_NULL_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_NULL_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_NULL_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_NULL_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_NULL_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_NULL_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_CAMELLIA_256_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_256_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_AES_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_AES_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_RC4_128_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_3DES_EDE_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_NULL_SHA)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_NULL_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_NULL_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_ECDSA_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_RSA_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDH_RSA_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_128_GCM_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_256_GCM_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_PSK_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_CAMELLIA_128_CBC_SHA256)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_PSK_WITH_CAMELLIA_256_CBC_SHA384)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_128_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_256_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_128_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_RSA_WITH_AES_256_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_128_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_RSA_WITH_AES_256_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_128_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_256_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_128_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_PSK_WITH_AES_256_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_128_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_DHE_PSK_WITH_AES_256_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CCM)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_128_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECDHE_ECDSA_WITH_AES_256_CCM_8)
        CASE_RETURN_STRING(MBEDTLS_TLS_ECJPAKE_WITH_AES_128_CCM_8)
        default:
        return "Unknown";
    }
/* WICED_MBEDTLS End */
