...
/* mbedtls_sha1_context structure has been
...
/* WICED_MBEDTLS Start */
void sha1_hmac_starts(sha1_hmac_context * ctx, const unsigned char *key,
              uint32_t keylen);
 ...
 */
void sha1_hmac_update(sha1_hmac_context * ctx, const unsigned char *input,
              uint32_t ilen);
