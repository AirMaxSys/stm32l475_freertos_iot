...
/* mbedtls_sha256_context and sha2_hmac_context
 *  structures have been moved to crypto_structures.h
 */
 ...
 */
void sha2_hmac_update(sha2_hmac_context * ctx, const unsigned char *input,
              uint32_t ilen );
