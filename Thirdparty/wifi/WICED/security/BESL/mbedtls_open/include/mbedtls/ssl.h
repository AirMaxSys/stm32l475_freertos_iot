...
/* WICED_MBEDTLS Start */
/* These are just moved from ssl_tls.c file of mbedtls to here. */
...
/* TODO: Remove this structure from here as it is duplicated here. need to use original structure directly. */
typedef struct
{
...
#endif
    /* WICED_MBEDTLS Start */
    const char* peer_cn; /* Peer common name */
    /* WICED_MBEDTLS End */
};
...
struct mbedtls_ssl_context
{
    ...
    int received_packet_bytes_skipped;
    uint16_t received_packet_length;

    size_t original_in_msglen;    /* This has original ssl->in_msglen before decryption */

    tls_transport_protocol_t transport_protocol;

    uint32_t* outgoing_packet;
    ...
    */
    ...
    uint16_t      defragmentation_buffer_bytes_skipped;

    uint8_t       randbytes[64];
    uint8_t       resume;

    tls_packet_receive_option_t packet_receive_option;
    /* WICED_MBEDTLS End */
...
/* WICED_MBEDTLS Start */
/**
 * \brief          cleanup a SSL configuration context
 *
 * \param conf     SSL configuration context
 */
